...
Not all features of the API are implemented in the plugin yet. If something is missing feel free to send a [pull request](https://github.com/flutter/flutterfire/pull/new/master) or file an [issue](https://github.com/flutter/flutter/issues/new).
